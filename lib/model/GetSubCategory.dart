...
GetSubCategory copyWith({  List<Getsubcategory>? getsubcategory,
}) => GetSubCategory(  getsubcategory: getsubcategory ?? _getsubcategory,
);
...
class Getsubcategory {
  ...
  dynamic _category;
Getsubcategory copyWith({  int? id,
  String? subCategoryName,
  String? subcategoryImage,
  dynamic category,
}) => Getsubcategory(  id: id ?? _id,
